...
dataform / api / 認可 / IaC / CLI を横断するテスト戦略を集約。

- `07-testing/test-concept.md`: **テスト基本方針の正本**。テストピラミッドの実現、スキーマ契約、スパースな staging データ対策、PDP/PEP テスト、新規追加時・変更時の CI ゲート、Terraform/CLI、build-once/promote 各段の配置を、2026 年の公式リファレンス付きでまとめる。
